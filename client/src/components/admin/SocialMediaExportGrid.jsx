                            ...
                            {products.map(p => {
                                ...
                                return (
                                    <div
                                        ...
                                        className={`relative bg-zinc-950 border rounded-xl overflow-hidden cursor-pointer flex flex-col transition-all duration-200 ${isSelected
                                                ? "border-red-500 shadow-lg shadow-red-900/30 ring-2 ring-red-500/30"
                                                : "border-zinc-800 hover:border-zinc-600 hover:shadow-lg"
                                            }`}
                                    >
                                        <div className={`absolute top-2.5 left-2.5 z-10 w-5 h-5 rounded border-2 flex items-center justify-center transition-all ${isSelected ? "bg-red-500 border-red-400" : "bg-zinc-900/80 border-zinc-600"
                                            }`}>
